...
- **3 + 3** — lifts + cardio per week
- **≤ 45 min** — required session cap (bonus work fills leftover time)
...
Preferred rotation — days aren't locked to the calendar; the app tracks the rotation, not the weekday.

| Day | Session | Type |
|----:|---------|------|
| 1 | Lower | Lift |
| 2 | Zone 2 | Easy cardio |
| 3 | Upper A | Lift |
| 4 | VO₂max | Intervals |
| 5 | Upper B | Lift |
| 6 | Saturday | Threshold **or** Endurance |
| 7 | Rest | Recover |
...
Prescriptions show **base (Establish) volume**; set counts scale by phase (see [Periodization](#how-it-varies-by-period)).

### 01 · Lower — *Lift, ~40 min*
Warm-up + power primer, then hinge / squat / single-leg / hamstrings / calves / core.
...
**30–45 min continuous** · RPE 3–4 · full sentences · aim 40–45 when time allows.

### 03 · Upper A — *Lift, ~40 min*
Incline + overhead press, vertical + horizontal pull, delts.
...
| Rope Triceps Pushdown *(bonus)* | 1–2 × 10–15 | 1–2 RIR · triceps |
| Dead Hang ✦ *(mobility)* | 1–2 × 30–60s | decompression + grip (partial/supported ok) |
...
Pull-led upper + posterior chain, secondary legs, loaded carry.
...
| Hammer Curl *(bonus)* | 1–2 × 10–15 | 1–2 RIR · biceps/brachialis |
| OH Rope Triceps Extension *(bonus)* | 1 × 10–15 | skip if dips done |

### 06 · Saturday — Threshold *or* Endurance — *Cardio, 25–75 min*
The periodized wildcard; which one depends on the phase (see [Cardio by phase](#cardio-by-phase)).

- **Option A · Threshold** — 20–25 min @ RPE 7–8 · 8 min warm-up · 5 min cool-down · "comfortably hard"
- **Option B · Endurance** — 40–45 min very easy Zone 2 · optional stretch to 60–75 min (a bonus, never a required session)

### 07 · Rest — *Recover*

**Walk · daylight · sleep** · optional easy mobility — no scored work.
...
**Threshold** (Saturday A)
- Establish: 20–25 min @ RPE 7–8
- Build: ~25 min @ RPE 7–8 · **every** build week
- Peak: 25–30 min @ RPE 7–8
- Deloads: swap → 30–40 min easy Zone 2
- Taper: swap → 25–30 min easy Zone 2

**Zone 2** (easy base)
- Establish: 30–45 min · RPE 3–4
- Build / Peak: 40–45 min continuous
- Taper: 25–35 min very easy

**Endurance** (Saturday B)
- Establish: 40–45 min easy · 60–75 optional bonus
- Build: 40–45 min very easy · RPE 3
- Peak: 45 min · opportunistic 60–75
...
The base program is the minimum that always gets done. Everything else is earned by leftover time — and taken away when recovery matters more. **The app hides bonus lifts automatically in deload, taper, and recovery.**

### Optional-work rules
- **Required first.** Base lifts, Farmer's walk and prehab always take priority; bonus never pushes a session past 45 minutes.
- **Time-boxed.** One bonus round with ~5 min left, two rounds with ~10. Supersets and tri-sets are ideal here.
- **Effort.** Keep most bonus sets 1–2 RIR; only safe isolations may touch 0–1 RIR on the last set.
...
- **Both sets at the top?** Add ~2.5–5% load and drop back to the low end.
- **Pull-ups & dips:** add reps first, external weight later.
...
History-aware, given prior irritation:
- **Neutral / semi-neutral grips** where comfortable.
- Overhead press swaps to a **landmine press** if provocative.
- Dips stay **upright-ish, never forced through deep shoulder extension** — assisted to hit the range, start with one set for the first 2–3 exposures.
- Dead hangs are optional and may be **partial or supported**.
